...
$('document').ready(function(){
		...
		$(window).resize(function(){
			...
			$('#b11').animate({top:180, left: vw-75},500);
		    $('#b22').animate({top:180, left: vw-25},500);
		    $('#b33').animate({top:180, left: vw+25},500);
			$('#b44').animate({top:240, left: vw-150},500);
			$('#b55').animate({top:240, left: vw-100},500);
			$('#b66').animate({top:240, left: vw-50},500);
			$('#b77').animate({top:240, left: vw+0},500);
			$('#b88').animate({top:240, left: vw+50},500);
			$('#b99').animate({top:240, left: vw+100},500);			
